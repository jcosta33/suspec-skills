...
`AGENTS.md` mapping abstract slot names to real commands (a repo without the table adds one by
hand). Skills reference the slots by name and degrade gracefully when an entry is
missing.
