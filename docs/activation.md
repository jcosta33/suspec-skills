...
1. action and target;
2. observable explicit and implicit triggers;
3. the dangerous shortcut refused;
4. adjacent work excluded.

Open with the work. Use `ALWAYS apply` only for a genuine automatic trigger. Route by task type, not a
